...
#ifndef _POSIX_ERCOS_EDROOM_BP_H_
#define _POSIX_ERCOS_EDROOM_BP_H_
...
#include "../../../../../edroombp/include/edroombp_swr/edroomtypes.h"

#ifndef CONFIG_DEBUG_PRIMITIVES_SWR_NDEBUG
...
public:
    ...
    /*
     * This method is for debug purpose in case of need the value of the
...
public:
	...
	static inline TEDROOMIRQMask GetIRQMask(void) { return 0; };
	 ...
	 /*!
	 * \brief This method disables an interrupt but does not change the IRQ
	 * mask
	 */
	static void DisableIRQ(uint32_t IRQVectorNumber);

	 /*!
	 * \brief This method enables an interrupt but does not change the IRQ
	 * mask
	 */
...
#endif	/*_POSIX_ERCOS_EDROOM_BP_H_*/
