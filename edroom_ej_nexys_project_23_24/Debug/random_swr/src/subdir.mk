...
random_swr/src/%.o: ../random_swr/src/%.cpp random_swr/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-random_swr-2f-src

clean-random_swr-2f-src:
	-$(RM) ./random_swr/src/random.d ./random_swr/src/random.o

.PHONY: clean-random_swr-2f-src
