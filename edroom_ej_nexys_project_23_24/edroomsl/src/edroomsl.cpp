...
#include "../../edroomsl/include/public/edroomsl_iface_v1.h"
...
CEDROOMNonMaskIRQInterface::CEDROOMNonMaskIRQInterface(Pr_IRQHandler irqHandler,
	...
	CEDROOMIRQInterface(irqHandler, idleIrqHandler, IRQEventLook, endIrqLook, 0) {
...
CEDROOMTimingSAP::CEDROOMTimingSAP(CEDROOMComponent *p_Component_,
	...
	m_SynchrSem(0), m_TimerTask(EDROOMfunTimer, p_Component_->m_NomPriority,
...
CEDROOMComponent::CEDROOMComponent(const char *name,
	TEDROOMComponentID componentID, TEDROOMUInt16 numPri, TEDROOMUInt32 numMaxM,
	TEDROOMPriority prioTask, TEDROOMUInt32 stack,
	CEDROOMComponentMemory *pComponentMemory) :
	EDROOMName(name), m_ComponentID(componentID), m_SynchrMsgPool(
...
void CEDROOMComponentMemory::SetMemory(TEDROOMUInt32 asynMsgNumber,
	...
	TEDROOMUInt32 queueNodesNumber, CEDROOMQueue::CQueueNode *pQueueNodesMemory,
	TEDROOMBool *pQueueNodesMarksMemory,
	CEDROOMQueue::CQueueHead *pQueueHeadsMemory) {

m_MessagesPool.SetMemory(asynMsgNumber, pMessagesMemory, pMessagesMarksMemory);
